  ...
  <div class="section">
    <div class="container">
      ...
      <div class="box">
        ...
        <button class="button is-link is-outlined" v-on:click="previousPage()">戻る</button>
        <button class="button is-link is-outlined" v-on:click="inputConfirm()">確認</button>
      </div>
    </div>
  </div>
</template>
